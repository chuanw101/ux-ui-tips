...
// Use this function to validate the form data. Accepts an object with {username, topic, tip}. Returns { isValid: boolean, and errors: Object }
...
const submitDiagnostics = (submissionObj) => {
  ...
  fetch('/api/diagnostics', {
    ...
    body: JSON.stringify(submissionObj.errors, null, "    "),
  })
    .then((response) => response.json())
    .then((data) => {
      showErrors(data);
